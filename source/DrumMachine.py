...
instruments = (
    (
        "kick", #Name
        0,  # MIDI note
        (0.9, 0.1, 0.2, 0.1, 0.9, 0.1, 0.2, 0.1, 0.9, 0.1, 0.2, 0.1, 0.9, 0.1, 0.2, 0.1),   #Hit probability for each 16th note in measure
        (1, 0)  #Relative probability for hit if not previously hit, previously hit
    ),
    (
        "snare",
        1,
        (0.5, 0.1, 0.5, 0.1, 0.5, 0.1, 0.5, 0.1, 0.5, 0.1, 0.5, 0.1, 0.5, 0.1, 0.5, 0.1),
        (1, 0)
    ),
    (
        "closed hat",
    ...
    (
        "open hat",
        4,
        (0.3, 0.1, 0.2, 0.1, 0.3, 0.1, 0.2, 0.1, 0.3, 0.1, 0.2, 0.1, 0.3, 0.1, 0.2, 0.1),
        (1, 0)
    ),
    (
        "tom",
